<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"E:\wamp64\www\tp\public\help/application/help\view\index\index.html";i:1564561588;s:69:"E:\wamp64\www\tp\public\help\application\help\view\public\header.html";i:1564556721;s:67:"E:\wamp64\www\tp\public\help\application\help\view\public\left.html";i:1564564754;}*/ ?>
<!doctype html>
            ...
            <div class="layui-col-md12">
                <div class="layui-card">
                    ...
                    <div class="layui-card-body" style="padding-top: 35px">
                        <form class="layui-form" action="<?php echo url('index/edit'); ?>" method="post">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" id="type" name="type" required="" lay-verify="required"
                                           autocomplete="off" class="layui-input" value="<?php echo $db['type']; ?>">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label for="username" class="layui-form-label">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" id="hostname" name="hostname" required="" lay-verify="required"
                                           autocomplete="off" class="layui-input" value="<?php echo $db['hostname']; ?>">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label for="username" class="layui-form-label">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" id="database" name="database" required="" lay-verify="required"
                                           autocomplete="off" class="layui-input" value="<?php echo $db['database']; ?>">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label for="username" class="layui-form-label">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" id="username" name="username" required="" lay-verify="required"
                                           autocomplete="off" class="layui-input" value="<?php echo $db['username']; ?>">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label for="username" class="layui-form-label">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" id="password" name="password" required="" lay-verify="required"
                                           autocomplete="off" class="layui-input" value="<?php echo $db['password']; ?>">
                                </div>
                            </div>
                            <div class="layui-form-item">
