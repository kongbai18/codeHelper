<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"E:\wamp64\www\tp\public\tph2\codeRepository\amaze\View\edit.html";i:1556261712;}*/ ?>
{extend name="layout" /}
{block name="content"}
<!-- 内容区域 -->
<div class="tpl-content-wrapper">
				...
				<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
						<div class="widget am-cf">
								<div class="widget-head am-cf">
										<div class="widget-title am-fl">编辑<?php echo pressTableDict($tableName); ?></div>
	...
	<div class="am-form-group">
			<label for="<?php echo $tableInfo[$columnNameKey]; ?>" class="am-u-sm-12 am-form-label am-text-left"><?php echo pressFieldDict($tableName, $tableInfo[$columnNameKey]); ?>
